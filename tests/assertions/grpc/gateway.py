...
def assert_get_account_details_response_user_with_active_debit_card_account(
    ...
    expected = GetAccountDetailsResponse(
        details=AccountDetails(
            account=Account(
                id="ad995534-aff7-404b-ae51-2f7c2e5cd044",
                type=ACCOUNT_TYPE_DEBIT_CARD,
                status=ACCOUNT_STATUS_ACTIVE,
                user_id="8b0e7c2a-1b6a-4e5d-9f1a-1b3f2a7c9e21",
                balance=9999999999999.75,
            ),
            cards=[
                Card(
                    id="4e8ddebd-0ae5-4759-aadf-36098bf142b7",
                    pin="2345",
                    cvv="333",
                    type=CARD_TYPE_VIRTUAL,
                    status=CARD_STATUS_ACTIVE,
                    account_id="ad995534-aff7-404b-ae51-2f7c2e5cd044",
                    card_number="7771111111111111",
                    card_holder="IVAN PETROV",
                    expiry_date=to_proto_test_date(date(2028, 12, 31)),
                    payment_system=CARD_PAYMENT_SYSTEM_VISA,
                ),
                Card(
                    id="99286de8-7e9f-422a-9002-52d5e9be32e9",
                    pin="1234",
                    cvv="111",
                    type=CARD_TYPE_PHYSICAL,
                    status=CARD_STATUS_ACTIVE,
                    account_id="ad995534-aff7-404b-ae51-2f7c2e5cd044",
                    card_number="6600000000000004",
                    card_holder="IVAN PETROV",
                    expiry_date= to_proto_test_date(date(2028, 8, 30)),
